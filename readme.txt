=== CUF Clean upload folder===
Contributors: nicearma
Donate link: 
Tags: image, file, clean, clean upload folder, upload cleanup, cleanup, cleanup upload, delete files
...
* Change to AngularJS 1.4.X
* Change all PHP code
* A lots of change (better code)
