...
<table class="wp-list-table widefat fixed">
        ...
        <tr>
            ...
            <td>
                <input ng-disabled="true" type="checkbox"
                       ng-model="options.admin" />
            </td>
        </tr>
        <tr>
            <td scope="row">
                <p>
                    <?php _e("Slice call", 'cuf'); ?>
                </p>

                <p>
                    <small>
                        <?php _e("This plugin will verify all files with Ajax, this can be hard to process to your browser and your server, adapt this number to make it work", 'cuf'); ?>
                    </small>
                </p>
            ...
            <td>
                <input type="number"
                       ng-model="options.slice" ng-disable/>
            </td>
        </tr>
        <tr>
            <td scope="row">
        ...
        <tr>
            <td scope="row">
                <p>
                    <?php _e("Backup system", 'cuf'); ?> <b>Version 1.1</b>
                </p>
            ...
            <td>
                <input ng-disabled="true" ng-disabled="disabledBackupOption" type="checkbox"
        ...
        <tr>
            <td scope="row">
                <p>
                    <?php _e("Create backup path", 'cuf'); ?>  <b>Version 1.1</b>
                </p>
            </td>
            <td>
                <button ng-disabled="true"  ng-if="statusBackup.inServer<1"
        ...
        <tr>
            <td scope="row">
                <p>
                    <?php _e("Delete attach file", 'cuf'); ?>  <b>Version 1.1</b>
                </p>
                <p>
                    <small>
            ...
            <td>
               <input ng-disabled="true" type="checkbox" ng-model="options.deleteAttached" ng-change="refreshDeleteButton()" />
