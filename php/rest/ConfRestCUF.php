...
add_action('wp_ajax_cuf_verify_files', 'cuf_verify_files');

function cuf_verify_files()
{
    $filesRest = new FileRestCUF();
    $filesRest->verifyFiles();
}



add_action('wp_ajax_cuf_delete_file', 'cuf_delete_file');

function cuf_delete_file()
{
    $filesRest = new FileRestCUF();
    $filesRest->deleteFile();
}


add_action('wp_ajax_cuf_get_shortcodes_files', 'cuf_get_shortcodes_files');

function cuf_get_shortcodes_files()
{
    ob_clean();
    $filesRest = new FileRestCUF();
    $filesRest->readShortCodes();
}